...
data modify storage mot_uav:io result set value {left_slot_id:0, down_slot_id:0, right_slot_id:0, program:{}, fans:[0.0d, 0.0d, 0.0d], motion_static:0, list_impulse:[], velocity:[0.0d, 0.0d, 0.0d], angular_vec:[0.0d, 0.0d, 0.0d], angular_len:0, position:[0.0d, 0.0d, 0.0d], ivec:[0.0d, 0.0d, 0.0d], jvec:[0.0d, 0.0d, 0.0d], kvec:[0.0d, 0.0d, 0.0d], xyzw:[0.0d, 0.0d, 0.0d, 0.0d], start_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], orth_xyzw:[0.0d, 0.0d, 0.0d, 0.0d], quat_phi:0}

execute store result storage mot_uav:io result.left_slot_id int 1 run scoreboard players get left_slot_id int
execute store result storage mot_uav:io result.down_slot_id int 1 run scoreboard players get down_slot_id int
execute store result storage mot_uav:io result.right_slot_id int 1 run scoreboard players get right_slot_id int
data modify storage mot_uav:io result.program set from storage mot_uav:io program
execute store result storage mot_uav:io result.fans[0] double 0.0001 run scoreboard players get fans_power int
execute store result storage mot_uav:io result.fans[1] double 0.0001 run scoreboard players get fans_theta int
execute store result storage mot_uav:io result.fans[2] double 0.0001 run scoreboard players get fans_timer int
execute store result storage mot_uav:io result.motion_static int 1 run scoreboard players get motion_static int
data modify storage mot_uav:io result.list_impulse set from storage mot_uav:io list_impulse
